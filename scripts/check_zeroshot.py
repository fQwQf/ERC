...
def main():
    ...
    print(f"Loading base model in 4-bit for ZERO-SHOT on {device}...")
    ...
    print(f"\n{'='*40}")
    print(f"ZERO-SHOT RESULTS FOR {args.dataset.upper()}")
    print(f"{'='*40}")
    ...
    # Save results
    output_path = Path(f"outputs/zeroshot_{args.dataset}.json")
